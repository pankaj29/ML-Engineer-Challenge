...
![Training curves from the run: loss, validation accuracy, and the learning-rate schedule](../../docs/images/training-curves.png)

*Produced by the training run itself and extracted from the notebook's output,
not redrawn from the numbers.*
